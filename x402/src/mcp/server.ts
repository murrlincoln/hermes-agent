...
const ENDPOINT_EXAMPLES: Record<string, string> = {
  ...
  'https://stableenrich.dev/api/serper/news': 'Serper News (StableEnrich): POST https://stableenrich.dev/api/serper/news body={"q":"coinbase"} headers={"Content-Type":"application/json"}',
  'https://stableenrich.dev/api/serper/images': 'Serper Images (StableEnrich): POST https://stableenrich.dev/api/serper/images body={"q":"coinbase logo"} headers={"Content-Type":"application/json"}',
  ...
  'https://api.nansen.ai/api/v1/smart-money/netflow': 'Nansen Smart Money Netflow: POST https://api.nansen.ai/api/v1/smart-money/netflow body={"chains":["ethereum"],"timeframe":"24h"} headers={"Content-Type":"application/json","x-api-key":"<NANSEN_API_KEY>"}',
  ...
  'https://stableenrich.dev/api/clado/contacts-enrich': 'Clado Contacts Enrich: POST https://stableenrich.dev/api/clado/contacts-enrich body={"email":"user@example.com"} headers={"Content-Type":"application/json"}',
  ...
  'https://stablesocial.dev/api/instagram/search': 'Instagram Search (StableSocial): POST https://stablesocial.dev/api/instagram/search body={"handle":"coinbase"} headers={"Content-Type":"application/json"}',
  ...
  'https://fal.x402.paysponge.com/fal-ai/flux/schnell': 'FLUX Schnell (fal, async): POST https://fal.x402.paysponge.com/fal-ai/flux/schnell body={"prompt":"futuristic city skyline"} headers={"Content-Type":"application/json"}',
  'https://stablevoice.dev/api/speech': 'Chatterbox TTS (StableVoice, advanced): POST https://stablevoice.dev/api/speech body={"text":"Hello world","voice":"alloy","output":{"format":"mp3","sample_rate":44100}} headers={"Content-Type":"application/json"}',
  ...
  'https://stableenrich.dev/api/google-maps/text-search/full': 'Google Maps Place Search: POST https://stableenrich.dev/api/google-maps/text-search/full body={"textQuery":"best coffee near Times Square"} headers={"Content-Type":"application/json"}',
  ...
  'https://stablemusic.dev/api/search': 'Music Search (StableMusic): POST https://stablemusic.dev/api/search body={"query":"lofi chill"} headers={"Content-Type":"application/json"}',
}
